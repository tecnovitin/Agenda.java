...
public class CalendarioController implements trocaTela, Menu {
    ...
    public void config() {
        ...
        if (adms != null) {
            for (Administrador ad : adms) {
                ...
                item.setOnAction(event -> {
                    admLista.setText(ad.getNome());
                    updateButtonState(); // Atualiza o botão assim que o profissional for selecionado
                });
        ...
        btAgendar.setOnAction(event -> {
            ...
            if (data == null || horaSelecionada == null || profissional == null || profissional.isEmpty()) {
    ...
    private void updateButtonState() {
        btAgendar.setDisable(
                admLista.getText().isEmpty() ||
                        ...
                        usuarioAnotacao.getText().isEmpty()
        );
    }
